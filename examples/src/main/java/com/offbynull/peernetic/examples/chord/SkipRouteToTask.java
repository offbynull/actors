...
final class SkipRouteToTask implements Coroutine {
    
    private static final Logger LOG = LoggerFactory.getLogger(SkipRouteToTask.class);
    ...
    public SkipRouteToTask(String sourceId, State state, ExternalPointer bootstrapNode, NodeId findId, NodeId skipId) {
