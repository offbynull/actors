...
public class QueryForFingerTableProcessorTest {

    public QueryForFingerTableProcessorTest() {
    }
    ...
    public void testSuccess() throws Throwable {
        ...
        QueryForFingerTableProcessor qfftp = new QueryForFingerTableProcessor(_000Address);
        ...
        pr = qfftp.process(1L, inEvent, tidGen);
    ...
    public void testFailure() throws Throwable {
        ...
        qfftp.process(1L, inEvent, tidGen);
    }
}