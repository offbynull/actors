...
public final class SimpleLine implements Line {
    ...
    private final Duration minDelayPerKb;
    private final Duration maxJitterPerKb;
    private final double dropChancePerKb;
    private final double nonRepeatChancePerKb;
    ...
    @Override
    public Collection<TransitMessage> messageDepart(Instant time, BufferMessage departMessage) {
    ...
    @Override
    public Collection<BufferMessage> messageArrive(Instant time, TransitMessage transitMessage) {
        Validate.notNull(time);
        Validate.notNull(transitMessage);
        
        BufferMessage bufferMessage = new BufferMessage(transitMessage.getData(), transitMessage.getSource(),
