 ...
 */
package com.offbynull.peernetic.nettyhelper.simulation;
 ...
 * {@link RandomLine} object with a drop rate of 0.01 gets asked to process a 1000 byte packet, there's a 10% chance of that the message
 * won't make it out.
 * @author Kasra Faghihi
 */
public final class RandomLine implements Line {
    ...
    public List<TransitPacket> depart(long timestamp, SocketAddress from, SocketAddress to, ByteBuffer data) {
        ...
        List<TransitPacket> packets = new LinkedList<>();
        ...
        do {
            ...
            packets.add(new TransitPacket(from, to, data, arrivalTime));
    ...
    @Override
    public Collection<TransitPacket> arrive(long timestamp, Collection<TransitPacket> packets) {
        return packets;
    }
}
