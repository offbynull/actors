...
public final class ResponseQueue {
     ...
     */
    public boolean addResponse(Message original, Object response) {
        Validate.notNull(response);
        
        ResponseDetails responseDetails = original.getResponseDetails();
        ...
        Message responseMsg;
        responseMsg = Message.createResponseMessage(responseDetails.getKey(), response);
        
        queue.put(responseDetails.getWriter(), responseMsg);
