 ...
 * </ul>
 * How {@link #toLinkId(com.offbynull.actors.core.shuttle.Address) } works...
 * <p>
 * When using {@link #toLinkId(com.offbynull.actors.core.shuttle.Address) } with a remote address (an address with the prefix
 ...
 * <p>
 * When using {@link #toLinkId(com.offbynull.actors.core.shuttle.Address) } with your local address (an address with the prefix
...
public final class SimpleAddressTransformer implements AddressTransformer {
     ...
     * @param selfLinkId link id to return when {@link #toLinkId(com.offbynull.actors.core.shuttle.Address) } is called with an address
