 ...
 */
public final class RequestTcpMappingNatPmpRequest extends NatPmpRequest {
     ...
     */
    public RequestTcpMappingNatPmpRequest(int internalPort, int suggestedExternalPort, long lifetime) {
        super(2);
