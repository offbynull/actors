...
public final class TransmissionOutputEndpoint<A> implements Endpoint {

    private Endpoint transActorEndpoint;
    private A address;

    public TransmissionOutputEndpoint(Endpoint transActorEndpoint, A address) {
    ...
    public boolean equals(Object obj) {
        ...
        final TransmissionOutputEndpoint other = (TransmissionOutputEndpoint) obj;
