...
import com.offbynull.peernetic.rpccommon.services.nat.NatHelperService;
import com.offbynull.peernetic.rpccommon.services.nat.NatHelperServiceImplementation;
import com.offbynull.peernetic.rpccommon.services.nat.NatHelperCallable;
...
public class NatHelperServiceTest {
   ...
   public void checkForNatTest() throws Throwable {
       NatHelperCallable callable = new NatHelperCallable(client, 40990, new InetSocketAddress("localhost", 40991));
        com.offbynull.peernetic.rpccommon.services.nat.NatHelperCallable.Result result = callable.call();
